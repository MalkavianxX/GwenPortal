...
def crear_preferencia_MP(request): 
    ...
    preference_data = {
        ...
        "back_urls": {
            "success": "http://127.0.0.1:8000/micontenido/pago_success/",
            "failure": "http://127.0.0.1:8000/micontenido/pago_danger/",
            "pending": "http://127.0.0.1:8000/micontenido/pago_pendiente/"
        },
        "payer": {
            "name": "Juan",
            "surname": "Lopez",
    ...
    requestPaypal.request_body (
        {
            ...
            "application_context":{
                "return_url":"http://127.0.0.1:8000/micontenido/pago_success/",
                "cancel_url":"http://127.0.0.1:8000/micontenido/pago_danger/",
